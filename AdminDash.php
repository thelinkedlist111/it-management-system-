...
<div class="form-container">
  <form method="GET" action="../Controller/Create.php">
    <button class="submit-btn">create</button>
  </form>
  <form method="GET" action="../Controller/AdminRead.php">
    <button class="submit-btn">Read</button>
  </form>
  <form method="GET" action="../Controller/AdminUpdate.php">
    <input type="text" name="id" value="">
    <button class="submit-btn">update</button>
  </form>
  <form method="GET" action="../Controller/AdminUpdateTick.php">
    <input type="text" name="id" value="">
    <button class="submit-btn">update Ticket</button>
  </form>
  <form method="POST" action="../Controller/AdminDelete.php">
     <input type="text" name="id" value="">
