...
<div class="form-container">
  <h2>IT Support Booking</h2>
  <form method="POST" action="../Controller/userCreate.php">
    ...
    <div class="Choose">
      <label><input type="radio" name="department" value="Design" required /> Design</label>
      <label><input type="radio" name="department" value="Construction" /> Construction</label>
      <label><input type="radio" name="department" value="Administrative" /> Administrative</label>
      <label><input type="radio" name="department" value="Finance" /> Finance</label>
      <label><input type="radio" name="department" value="HR" /> HR</label>
    </div>

    <label>Type of Issue :</label>
    <div class="Choose">
      <label><input type="radio" name="type" value="Software" required /> Software</label>
